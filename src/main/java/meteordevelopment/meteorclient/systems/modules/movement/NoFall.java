...
public class NoFall extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // Bucket mode
            ...
            if (placedWater) {
                timer++;
                if (mc.world.getBlockState(targetPos).getBlock() == placedItem1.block && mc.player.fallDistance == 0) {
        ...
        // Water bucket setting
            ...
            if (placedWater) {
                timer++;
                if (mc.world.getBlockState(targetPos).getBlock() == Blocks.WATER && mc.player.fallDistance == 0) {
                    useItem(InvUtils.findInHotbar(Items.BUCKET), false, targetPos, true);
